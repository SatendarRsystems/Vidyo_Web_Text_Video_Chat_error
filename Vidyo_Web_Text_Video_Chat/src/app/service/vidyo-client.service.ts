...
export class VidyoClientService {
    ...
    view;             // Div to display the video
    cameraPrivacy = false;  // camera privacy
    micPrivacy = false;     // microphone privacy

    cameras;         // array for available cameras
    selectedLocalCamera; // currently selected camera
    microphones; // array for available microphones
    selectedLocalMicrophone;  // currently selected microphone
    speakers; // array for available speakers
    selectedLocalSpeaker; // currently selected speaker
    ...
    */
    getSelectedDeviceInformation = () => {
        const selectedLocalSetting = { selectedLocalCamera: this.selectedLocalCamera, selectedLocalMicrophone: this.selectedLocalMicrophone, selectedLocalSpeaker: this.selectedLocalSpeaker };
